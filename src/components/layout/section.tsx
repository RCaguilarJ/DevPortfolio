...
export default function Section({
	...
	return (
		<section
			id={id}
			className={`w-full border-border/80 divide-y divide-border/80 divide-dashed flex flex-col items-start justify-start ${wrapperClassName ?? ""}`}
		>
			<div className="w-full flex flex-col gap-2 px-4 py-8 md:p-8">
				...
				<p className="text-base text-foreground/70 font-medium text-balance leading-relaxed">
					{description}
				</p>
			</div>
