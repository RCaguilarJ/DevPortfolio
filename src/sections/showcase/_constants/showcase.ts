...
export const showcaseHighlights: ShowcaseHighlight[] = [
	{
		id: "crm-mobile",
		title: "CRM mobile - interaccion",
		description: "Flujo de autenticacion y dashboard en movil.",
	...
	},
	{
		...
		description: "",
		src: "",
		poster: "/Minimalist Website Launch Computer Mockup Instagram Post.png",
		className:
